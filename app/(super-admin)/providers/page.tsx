                                ...
                                {displayedRows.map((provider, index) => (
                                    <tr key={provider.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-4 py-4 border-r-2 border-slate-300">
                                            <div className="flex items-center gap-3">
                                                <div onClick={() => handleViewDocument(provider.avatar!, "Avatar Preview")} className="w-10 h-10 rounded-full bg-slate-200 overflow-hidden flex-shrink-0 cursor-pointer hover:ring-2 hover:ring-blue-500 transition-all">
                                                    {provider.avatar ? (
                                                        <img
                                                            src={provider.avatar}
                                                            alt={provider.name}
