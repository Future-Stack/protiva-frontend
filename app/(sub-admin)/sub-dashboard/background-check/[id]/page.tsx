...
export default function BackgroundCheckDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const hasManagePermission = isSuperAdmin || currentUser?.adminPermissions?.isManageProvider;
            ...
            {!isLoading && provider && (
                <div className="flex items-center gap-4 py-4">
                    {isAlreadyActioned ? (
                        ...
                        <div className="px-6 py-2.5 bg-amber-50 text-amber-700 border border-amber-200 rounded-lg text-sm font-medium">
