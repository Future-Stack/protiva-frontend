...
import { CalendarCheck, CreditCard, Wallet, ChevronRight, Briefcase, Layers, Loader2, Search, UserCheck, Megaphone } from "lucide-react";
...
function SearchResultsContent() {
  ...
  const isLoading = isCatLoading || isJobsLoading || isUsersLoading || isProvidersLoading || isBookingsLoading || isTxLoading || isWithdrawLoading || isBannersLoading;
  const hasResults = filteredCategories.length > 0 || filteredJobs.length > 0 || filteredUsers.length > 0 || filteredProviders.length > 0 || filteredBookings.length > 0 || filteredTransactions.length > 0 || filteredWithdrawals.length > 0 || filteredBanners.length > 0;
  ...
  if (!query) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-slate-500 mt-2">Enter a keyword in the search bar to find categories or jobs.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Found {filteredCategories.length + filteredJobs.length + filteredProviders.length + filteredUsers.length + filteredBookings.length + filteredTransactions.length + filteredWithdrawals.length + filteredBanners.length} results for <span className="font-bold text-indigo-600">"{query}"</span></p>
      </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredCategories.map((cat: any) => (
                  <Link href="/sub-dashboard/categories" key={cat.id} className="block group">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredJobs.map((job: any) => (
                  <Link href="/sub-dashboard/jobs" key={job.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredUsers.map((user: any) => (
                  <Link href="/sub-dashboard/users" key={user.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredProviders.map((provider: any) => (
                  <Link href="/sub-dashboard/providers" key={provider.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full border-2 border-slate-100 overflow-hidden shrink-0">
                          {provider.avatar ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredBookings.map((booking: any) => (
                  <Link href="/sub-dashboard/bookings/requests" key={booking.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredBanners.map((banner: any) => (
                  <Link href="/sub-dashboard/marketing" key={banner.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredTransactions.map((tx: any) => (
                  <Link href="/sub-dashboard/transactions" key={tx.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="divide-y divide-slate-50 flex-1">
                {filteredWithdrawals.map((w: any) => (
                  <Link href="/sub-dashboard/transactions/withdrawals" key={w.id} className="block group">
                    <div className="px-6 py-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                      <div className="flex items-center gap-4">
...
export default function SubAdminSearchPage() {
  return (
    <Suspense fallback={
